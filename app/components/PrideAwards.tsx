...
const PrideAwards = ({ image, title, years, description }: AwardCardProps) => {
  return (
    <motion.div 
      ...
      className="w-full max-w-xs bg-white py-10 px-4 flex flex-col items-center text-center shadow-sm border border-gray-50 group hover:shadow-lg transition-all border-[#e0f7ff] border-2 duration-300"
    >
      {/* Logo Section */}
